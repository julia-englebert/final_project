...
# couldn't get gtsave to save to the "final" subdirectory
# will need to copy to "final" manually??
gtsave(data = maleedu_gt, filename = "maleedu_gt.html")
...
# copy to "final"
gtsave(data = cowedu_gt, filename = "cowedu_gt.html")
