...
```{r experimentalModels, eval = FALSE}
...
allData_inflated <- as_tibble(bind_rows(data1870j, data1880j, data1890j, 
  ...
  mutate(pct_male = male/pop*100, avg_value_farm = value_farm/n_farm, cows_per_farm = cows_per_person, 
         avg_value_implements = value_implements/n_farm, pct_urban = ifelse(pct_urban > 100, NA, pct_urban)) %>%
...
x <- left_join(allData_inflated, inflation, by = c("YEAR" = "year")) %>%
  # Use the multiplier column to adjust for inflation
  mutate(value_farm = value_farm*multiplier, value_implements = value_implements*multiplier) %>%
  mutate(avg_value_farm = value_farm/n_farm, avg_value_implements = value_implements/n_farm) %>%
  mutate("Value of Farms" = as.numeric(value_farm), "Average Farm Value" = as.numeric(avg_value_farm), 
...
saveRDS(Census_1870, file = "final/1870.rds")
saveRDS(Census_1880, file = "final/1880.rds")
saveRDS(Census_1890, file = "final/1890.rds")
saveRDS(Census_1900, file = "final/1900.rds")
saveRDS(Census_1910, file = "final/1910.rds")
saveRDS(Census_1920, file = "final/1920.rds")
saveRDS(Census_1930, file = "final/1930.rds")
saveRDS(Census_1940, file = "final/1940.rds")
saveRDS(Census_1950, file = "final/1950.rds")
saveRDS(Census_1960, file = "final/1960.rds")
