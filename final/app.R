                        ...
                        mainPanel("",
                                  tabsetPanel(id = "tabsMain",
                                              ...
                                              tabPanel("Cattle",
                                                       ...
                                                       p("An exploration of the effects of other livestock showed that horses are similarly associated with higher enrollment percentages, even when controlling for farm value. Horse data was only available for 1870 and 1890.")
                                              ),
